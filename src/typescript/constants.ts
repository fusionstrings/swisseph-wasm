// Auto-generated from swephexp.h
...
export const SEFLG_TEST_PLMOON = 2 * 1024 * 1024 | SEFLG_J2000 | SEFLG_ICRS |
...
export const SE_ECL_ALLTYPES_SOLAR = SE_ECL_CENTRAL | SE_ECL_NONCENTRAL |
  SE_ECL_TOTAL | SE_ECL_ANNULAR | SE_ECL_PARTIAL | SE_ECL_ANNULAR_TOTAL;
export const SE_ECL_ALLTYPES_LUNAR = SE_ECL_TOTAL | SE_ECL_PARTIAL |
  SE_ECL_PENUMBRAL;
...
export const SE_BIT_HINDU_RISING = SE_BIT_DISC_CENTER | SE_BIT_NO_REFRACTION |
...
export const SE_HELFLAG_AVKIND = SE_HELFLAG_AVKIND_VR | SE_HELFLAG_AVKIND_PTO |
...
export const SE_HELIACAL_AVKIND = SE_HELFLAG_AVKIND_VR | SE_HELFLAG_AVKIND_PTO |
  SE_HELFLAG_AVKIND_MIN7 | SE_HELFLAG_AVKIND_MIN9;
